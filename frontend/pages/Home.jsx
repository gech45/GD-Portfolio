...
function Home() {
  return (
    <main className='home page-content'>
      <section className='hero'><div className='hero-copy'><p className='eyebrow home-eyebrow'>Full stack developer</p><h1>Building digital experiences that <em>feel clear.</em></h1><p className='hero-intro'>I&apos;m Getachew Dargie, a developer who turns complex ideas into useful, considered products for the web.</p><div className='hero-actions'><a className='button button-dark' href="mailto:getachewdargie3721@gmail.com">Let&apos;s work together <span>↗</span></a><a className='text-link' href="/projects">See selected work <span>→</span></a></div></div><div className='profile-art'><img className='profile-image' src={profileImage} alt='Getachew Dargie' /><div className='profile-caption'><span>01</span><span>Designing with intent</span></div></div></section>
